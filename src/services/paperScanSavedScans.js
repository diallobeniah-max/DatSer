...
export const uploadSheetImage = async ({ supabase, userId, scanId, sheetId, dataUrl }) => {
  ...
  if (error) {
    throw new Error(error.message || 'The sheet image could not be saved.')
  }
  return path
}
