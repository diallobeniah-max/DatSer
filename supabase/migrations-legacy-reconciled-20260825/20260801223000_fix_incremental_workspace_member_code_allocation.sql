-- Deployed live migration: fix incremental workspace member code allocation.
-- Allocates only genuinely missing requested members, generates codes directly,
-- inserts directly into workspace_member_codes, and returns only requested assignments.
-- Never calls full workspace conversion during Add Member.
